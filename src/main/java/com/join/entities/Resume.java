...
public class Resume {
	...
	public String getResume_oktime() {
		return resume_oktime;
	}
	public void setResume_oktime(String resume_oktime) {
		this.resume_oktime = resume_oktime;
	}
	public String getResume_alook() {
		return resume_alook;
	}
	...
	public String toString() {
		return "Resume [resume_id=" + resume_id + ", resume_name=" + resume_name + ", resume_image=" + resume_image
				+ ", resume_address=" + resume_address + ", resume_offeryear=" + resume_offeryear + ", resume_sex="
				+ resume_sex + ", resume_status=" + resume_status + ", resume_email=" + resume_email + ", resume_money="
				+ resume_money + ", resume_wantadd=" + resume_wantadd + ", resume_zhineng=" + resume_zhineng
